...
_“[Pitch of Voiced Speech in the Short‐Time Fourier Transform: Algorithms, Ground Truths, and Evaluation Methods](https://bastibe.github.io/Dissertation-Website/)”_, Magna cum Laude   
...
_Machine Learning Developer_ - C, Python, Kaldi
...
_Introduction to Programming_, _Data and Algorithms_, _Applied
Programming_ and various lab classes and thesis supervisor
...
_Data Analysis, Audio, Image Processing_ - Python, C, Lua
...
**SENNHEISER AUDIO LABS** (2012-2014)

_Signal Processing Engineer_ - Python, C++, Qt, QML
...
_Embedded Software Developer_ - C, C++, Lua, Blackfin, Qt, Python
...
_Freelance Mac Software Developer_ - Obj-C, C, OpenGL
