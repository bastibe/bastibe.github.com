...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        world_map.countryClicked.connect(self.show_summary)
    ...
    @QtCore.Slot(str)
    def show_summary(self, country):
        country_data = self.covid_data[self.covid_data.location == country]
        self.summary_label.setText(str(country_data))
