...
A few months ago, I [talked about](http://bastibe.de/2015-11-03-matlab-engine-performance.html) the performance of calling Matlab from Python. Since then, I implemented a few optimizations that make working with Transplant a lot faster:

![timings](http://bastibe.de/static/2016-06/timings.png)
...
Lastly, I rewrote the ZeroMQ interaction to use `loadlibrary` instead of a Mex file. This has no impact on processing speed at all, but you don't have to [worry about](http://bastibe.de/2016-05-31-Matlab-FFI.html) compiling that C code any more.
