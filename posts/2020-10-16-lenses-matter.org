...
The argument, however, goes like this: Bigger pixels[fn:1] can capture a greater dynamic range, and bigger sensors are made from bigger pixels. Therefore, and here is the dangerous leap, cameras with bigger sensors take better pictures.

[fn:1] technically, “sensor elements”, not “picture elements”, i.e. “sensels”
