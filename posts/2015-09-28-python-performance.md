...
The problem is, this is very slow. For a $90 \times 200$ `cost_matrix`, this takes about 260 ms. Lots of loops? Lots of simple mathematics? Slow? That sounds like a perfect match for [Numpy](http://www.numpy.org/)!
...
Another avenue for performance optimization is [Numba](http://numba.pydata.org/). Numba applies dark and powerful magic to compile humble Python functions into blazingly fast machine code. It is proper magic, if you ask me. Simply add an innocuous little decorator to your functions, and let Numba do it's thing. If all goes well, your code will work just as before, except with unheard-of performance:
