...
You can either grab the individual installers for [Python](http:_python.org), [Numpy](http:__numpy.org), [Scipy](http:__scipy.org) and [Matplotlib](http:__matplotlib.org) from their respective websites, or get them pre-packaged from [pythonxy()](https:_/code.google.com/p/pythonxy/) or [EPD](http://www.enthought.com/products/epd.php).
