...
Windows Explorer now has tabs! Coming from macOS and Linux, I so missed *explorer tabs* that I added them to Windows 10 with [[https://www.stardock.com/products/groupy/][a plugin]]. I still feel handicapped whenever I have to interact with an older Windows box that doesn't have them. But Windows 11 does. Next, please fix the inevitable hangs in Explorer, please.
