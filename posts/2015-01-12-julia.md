...
It is actually nice to have a language that is built for scientific computation. Coming from Python, it is refreshing to have [array literals](https://docs.julialang.org/en/v1/manual/arrays/), ranges and [mathematics](https://docs.julialang.org/en/v1/base/math/) available without importing anything. Much like Python, Julia also has a proper [module system](https://docs.julialang.org/en/v1/manual/modules/), comprehensions, and more than one function per file.
...
And finally, Performance is surprisingly good! Although my algorithm spends almost all of its time doing FFTs, Julia performed about twice as fast as Python. This is pretty much exactly twice as much as I had expected! It also exposed more of the [features](https://docs.julialang.org/en/v1/base/math/?highlight=plan_fft#Base.plan_fft) of the underlying libraries, which could be used for another speed-up of some 10%.
