...
![vim_window_small](http://bastibe.de/static/2012-02/vim_window_small.png)
...
![vim_full_window_small](http://bastibe.de/static/2012-02/vim_full_window_small.png)
...
![emacs_small](http://bastibe.de/static/2012-02/emacs_small.png)

The thing you have to realize about Emacs is that… Emacs is powerful. People have called it [the thermonuclear text editor](http://www.emacswiki.org/emacs/NealStephenson), and for a reason. Emacs can edit text, of course, but that is really only the most mundane of its features. Really, Emacs is a little world of its own. You can read and write your mail from within Emacs, you can do spreadsheets, calendaring, it can host terminals, debuggers, compilers, there is Tetris, hell, it even includes its very own psychiatrist! Speaking off the record here, I have a suspicion that Emacs might achieve sentience pretty soon.

![emacs_window_small](http://bastibe.de/static/2012-02/emacs_window_small.png)
...
![textmate_window_small](http://bastibe.de/static/2012-02/textmate_window_small.png)
...
![sublimetext_window_small](http://bastibe.de/static/2012-02/sublimetext_window_small.png)
...
And it also supports [Vim key bindings](http://www.sublimetext.com/docs/2/vintage.html). Not very complete, but easily enough to be useful. Oh, and it is available cross-platform on Mac, Windows and Linux, too.
...
![bbedit](http://bastibe.de/static/2012-02/bbedit.png)
...
![textwrangler](http://bastibe.de/static/2012-02/textwrangler.png)
...
![subethaedit](http://bastibe.de/static/2012-02/subethaedit.png)
...
![smultron](http://bastibe.de/static/2012-02/smultron.png)
...
#### [SlickEdit](http://www.slickedit.com/products/slickedit)

![slickedit](http://bastibe.de/static/2012-02/slickedit.png)
...
![textedit](http://bastibe.de/static/2012-02/textedit.png)
...
![coda](http://bastibe.de/static/2012-02/coda.png)
...
![espresso](http://bastibe.de/static/2012-02/espresso.png)
