...
From now on, I will use [rsnapshot](http://rsnapshot.org/) for backups. [Here](http://web.archive.org/web/20170828071209/https://rayed.com/wordpress/?p=1693)'s a tutorial on how to set it up on a Mac. I have used rsnapshot for years at work, and it has never let me down. For syncronizing things between computers, I now use [syncthing](https://syncthing.net/). Both of these programs are not as user-friendly as Dropbox or Time Machine, but that is a small price to pay for a working backup.
