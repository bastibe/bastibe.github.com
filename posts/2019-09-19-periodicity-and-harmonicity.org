...
The answer exposes a lot of detail of how spectra work, and give us a glimpse into the inner workings of spectral phases. Let's start with that click: In that spectrum, we see that we can decompose a click into a sum of sine waves:
...
But what happens if we have more than one click? How does this change things?
...
[[https://bastibe.de/static/2019-09/train.png]]
