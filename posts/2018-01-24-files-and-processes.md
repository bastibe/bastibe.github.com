...
In the last few months, I have created three notable programming projects: [RunForrest](https://github.com/bastibe/RunForrest) saves function call graphs to disk and runs them in parallel processes; [TimeUp](https://github.com/bastibe/timeup) creates backups using rsync and keeps different numbers of hourly, daily, and weekly backups; and [JBOF](https://github.com/bastibe/jbof), which organizes large collections of data and metadata as structured, on-disk datasets.

These projects have one thing in common: They use Python to interact with external _things_, such as files, libraries, or processes. It surprised me that none of these projects were particularly hard to build, even though they accomplish "hard" tasks. This prompted some soul-searching about why I thought these tasks to be hard, and I have come up with two observations:
...
2) However, such small and simple programs are much less popular than bloated behemoths. I built RunForrest explicitly because [Dask](http:_dask.pydata.org) was too confusing and unpredictable for the job. I build JBOF because [h5py](http:__www.h5py.org_) was too complex and slow. And this is surprising, since these tools certainly are vastly more mature than anything I can whip up. But they were developed by large organizations to solve large-organization problems. But I am not a large organization, and my needs are different as well.
