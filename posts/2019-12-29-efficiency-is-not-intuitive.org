...
In my career as a software developer, I know these ideas as traits of good APIs: Orthogonal, minimal, composable. APIs are great not when they are as expansive and convenient as possible, but when they are most constrained and recombinable. That's what I understand as good design in both programming, and in professional UIs.

Which is quite the opposite of /Intuitive/. Quite the opposite of "easy to grasp without reading the manual". That's a description of a video game, not a professional tool. As professionals, we should seek and build empowering, efficient tools for adullts, not intuitive games maskerading as professional software.
