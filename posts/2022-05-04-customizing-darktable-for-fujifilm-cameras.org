...
[[http:/static/2022-05/fujifilm_auto_settings.lua][fujifilm ̲auto ̲settings.lua]]
...
- Two styles ~DR200~ and ~DR400~ for the dynamic range modes that brighten the image by one and two stops, respectively (I like to use the Tone Equalizer [[http:/static/2022-05/DR200.png][like this]]).
...
Download a zip file with all the above styles [[http:/static/2022-05/styles.zip][here]], and appropriately-renamed LUTs [[http:/static/2022-05/Fujifilm XTrans III.zip][here]]. (This section will be revised once I finish building my own set of LUTs).
