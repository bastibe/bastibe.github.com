...
I am writing my master's thesis in [Org Mode](http:/orgmode.org/), and export to LaTeX for publishing. For the most part, this works incredibly well. Using Org Mode instead of plain LaTeX means no more fiddly `\backslash{curly brace}` all over the place. No more scattering code fragments and markup across hundreds of files. And on top of that, deep integration with my research notes and task tracking system.
